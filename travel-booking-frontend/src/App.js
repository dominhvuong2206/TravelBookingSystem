    ...
    <BrowserRouter>
      ...
      <Container>
        <Routes>
          ...
          <Route path="/payment-return/:method/:bookingId" element={
            <CustomerRoute>
              <PaymentReturn />
            </CustomerRoute>
          } />
          <Route path="/payment-return/:method" element={
            <CustomerRoute>
              <PaymentReturn />
            </CustomerRoute>
          } />
          ...
          <Route path="/provider/services/:serviceId/edit" element={
            <ProviderRoute>
              <ServiceForm />
            </ProviderRoute>
          } />
          <Route path="/provider/services/:serviceId/bookings" element={
            <ProviderRoute>
              <ServiceBookings />
            </ProviderRoute>
          } />
          ...
          <Route path="/provider/stats" element={
            <ProviderRoute>
              <ProviderStats />
            </ProviderRoute>
          } />
