                    ...
                    <Navbar.Collapse id="travel-main-nav">
                        <Nav className="me-auto align-items-lg-center">
                            ...
                            <NavDropdown title={<span><FontAwesomeIcon icon="fa-solid fa-layer-group" className="me-2" />Danh mục</span>} id="category-nav-dropdown">
                                ...
                                {categories.map(c => <Link className="dropdown-item" key={c.id} to={`/?cateId=${c.id}`}>{c.name}</Link>)}
                            </NavDropdown>

                            {(roleLinks[role] || []).map(item => (
                                <Link to={item.to} style={navLinkStyle(item.to)} className="app-header-nav-link" key={item.to}>
                                ...
                                <Dropdown align="end">
                                    ...
                                    <Dropdown.Menu style={styles.userMenu}>
                                        ...
                                        <Dropdown.Item as={Link} to="/profile">
                                            <FontAwesomeIcon icon="fa-solid fa-house" className="me-2" />
                                            Hồ sơ cá nhân
                                        </Dropdown.Item>
